...
FontDescriptor *createFontDescriptor(CTFontDescriptorRef descriptor)
{
	...
	FontDescriptor *res = new FontDescriptor([[url path] UTF8String], [psName UTF8String], [family UTF8String], [style UTF8String], weight, width,
						 (symbolicTraits & kCTFontItalicTrait) != 0, false, (symbolicTraits & kCTFontMonoSpaceTrait) != 0);
